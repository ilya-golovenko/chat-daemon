...
IF NOT EXIST "%PROJECT_ROOT%\Jamroot" (
    ECHO Could not find Jamroot file required to build %PROJECT_NAME%
    EXIT /B 1
)
...
ECHO Starting build of %PROJECT_NAME%
