...
//
//---------------------------------------------------------------------------
#ifndef _chat_app_process_cpu_usage_hpp
#define _chat_app_process_cpu_usage_hpp
...
#if defined(CHAT_PLATFORM_WINDOWS)
typedef detail::win_process_cpu_usage process_cpu_usage;
#elif defined(CHAT_PLATFORM_LUNIX)
typedef detail::linux_process_cpu_usage process_cpu_usage;
#elif defined(CHAT_PLATFORM_FREEBSD)
typedef detail::freebsd_process_cpu_usage process_cpu_usage;
#else
#error Current operating system is not supported.
#endif
...
#endif  // _chat_app_process_cpu_usage_hpp
